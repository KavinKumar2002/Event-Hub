...
@endphp
                    ...
                    <div class="row" style="overflow: hidden;">
                        ...
                        <div class="col-md-6">
                            <div class="text-md-end dataTables_filter" id="dataTable_filter"
                                ...
                                <div><a href="/duplicateviewfull"><button
                                            class="btn btn-block btn-bold btn-primary justify-content-center"
                                            style="margin-right:20px">Search</button></a>{{$eventcount }} 
                    ...
                    <div class="row" style="overflow: hidden;">
                        ...
                        <div class="col-md-6">
                            <div class="text-md-end dataTables_filter" id="dataTable_filter"
                                ...
                                <a href="/duplicateindsearch"><button
                                            class="btn btn-block btn-bold btn-primary justify-content-center"
                    ...
                    <div class="row" style="overflow: hidden;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                ...
                                <a href="/duplicateteamsearch"><button
                                            class="btn btn-block btn-bold btn-primary justify-content-center"
    ...
    @foreach ($teamMemberDetails as $columnName => $member)
        @if ($columnName === "team_member_$i" && !is_null($member))
           <p>Team Member {{ $i }}: {{ $member }}</p>
        @endif
    @endforeach
@endfor
